  ...
  var isPaused = false;
      ...
      function togglePause() {
          if (isPaused) {
            isPaused = false;
            audio.play();           
            pauseButton.innerHTML = '<img src="assets/play.png" alt="Sound" width="30px" height="30px">';
            soundButton.innerHTML = '<img src="assets/suaraon.png" alt="Sound" width="49px" height="49px">';
          } else {
            isPaused = true;
            audio.pause();
            pauseButton.innerHTML = '<img src="assets/pause.png" alt="Sound" width="30px" height="30px">';
            soundButton.innerHTML = '<img src="assets/suaraoff.png" alt="Sound" width="49px" height="49px">';
          }
        }
      function toggleMenu() {
          if (isPaused) {
            menuBtn.innerHTML = '<img src="assets/closeMenuPopUp.png" alt="menu" style="display: none;">';
            menuBtn.innerHTML = '<img src="assets/menu.png" alt="menu" style="display: block;">';
            pauseMenu.style.display = 'none';
            isPaused = false;
            playpopup.style.display = 'none';
          } else {
            menuBtn.innerHTML = '<img src="assets/menu.png" alt="menu" style="display: block;">';
            menuBtn.innerHTML = '<img src="assets/closeMenuPopUp.png" alt="menu" style="display: block;">';
